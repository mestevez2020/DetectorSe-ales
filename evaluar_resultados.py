...
if __name__ == "__main__":
    ...
    parser.add_argument(
        '--test_path', default="test_alumnos", help='Select the testing data dir')
    parser.add_argument(
    ...
    tp, fp, thr, tot = precision_recall_curve(gt_dbboxes, det_dbboxes_instructor_1, show=False, ovr=0.5, images_dict=det_dimages)
    rec_1, prec_1, ap1_1 = draw_PR_fast(tp, fp, tot, show=False)

    tp, fp, thr, tot = precision_recall_curve(gt_dbboxes, det_dbboxes_instructor_2, show=False, ovr=0.5, images_dict=det_dimages)
